...
export default function ProjectCard({ project }: IProjectCardProps) {
    ...
    return (
        <div className='p-3 text-center w-96 flex flex-col items-center rounded-md'>
            ...
            <a className="text-gray-800 text-center text-3xl font-bold" href={project.projectUrl} target="_blank">{project.title}</a>
            <a className="text-center text-cyan-500 font-bold" href={project.companyUrl} target="_blank">{project.company}</a>
