        ...
        <section id="about">
            ...
            <div className={styles.aboutContent}>
                <div className={styles.aboutText}>
                    <p>Olá, sou Alessandro Massarotti Junior, Desenvolvedor Web junior, sou formado em Analise e desenvolvimento de sistemas e atuo na area de desenvolvimento a cerca de 1 ano.</p>
